...
(async () => {
  ...
  assert(result.titleFont.includes("KingHwa Old Song"), `reader title font is not KingHwa Old Song: ${result.titleFont}`);
  assert(result.headingFont.includes("KingHwa Old Song"), `reader section heading font is not KingHwa Old Song: ${result.headingFont}`);
  ...
  assert(!result.pullFont.includes("KingHwa Old Song"), `reader pull quote should use body typography: ${result.pullFont}`);
