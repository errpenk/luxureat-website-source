...
assert(read("assets/js/journal.js").includes("?category=${productCategory}#product-catalogue"), "Recipe product links do not open their matching catalogue category");
