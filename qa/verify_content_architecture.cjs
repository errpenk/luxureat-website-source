...
assert(integrationStyles.includes('--lux-zh-headline: "KingHwa Old Song Page"') && read("zh/contact.html").includes('KingHwaOldSong-contact-critical.woff2'), "Chinese headings do not use page-specific KingHwa typography");
assert(integrationStyles.includes('"KingHwa Old Song Complete"') && read("zh/contact.html").includes('KingHwaOldSong-complete.ttf') && integrationStyles.includes('html[lang^="zh"] .lux-cert-awards h2'), "Chinese headings do not fall back to the complete KingHwa font and award records are not explicitly KingHwa");
assert(integrationStyles.includes('--lux-zh-body: "LuxurEat ZhiSong Page"') && read("zh/contact.html").includes('LuxurEatZhiSong-contact-critical.woff2'), "Chinese body copy does not use page-specific ZhiSong typography");
