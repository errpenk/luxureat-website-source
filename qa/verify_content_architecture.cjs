...
assert(integrationStyles.includes('--lux-en-display: "Nyght Serif"') && integrationStyles.includes('--lux-en-heading: "Nyght Serif"') && integrationStyles.includes('NyghtSerif-Regular.woff2') && integrationStyles.includes('NyghtSerif-RegularItalic.woff2') && integrationStyles.includes('NyghtSerif-Bold.woff2'), "English headings do not use the bundled Nyght Serif family");
assert(integrationStyles.includes('--lux-en-body: "Spectral"') && integrationStyles.includes('Spectral-Regular.woff2') && integrationStyles.includes('Spectral-Italic.woff2') && integrationStyles.includes('Spectral-SemiBold.woff2'), "English body copy does not use the bundled Spectral family");
...
assert(integrationStyles.includes('--lux-zh-headline: "KingHwa Old Song"') && integrationStyles.includes('KingHwaOldSong-subset.woff2'), "Chinese headings do not use the supplied KingHwa Old Song font");
assert(integrationStyles.includes('--lux-zh-body: "LuxurEat ZhiSong Web"') && integrationStyles.includes('LuxurEatZhiSongWeb-subset.woff2'), "Chinese body copy does not use LXGW Neo ZhiSong");
...
assert(JSON.stringify([...new Set(registeredTextFonts)].sort()) === JSON.stringify(["KingHwa Old Song", "LuxurEat ZhiSong Web", "Nyght Serif", "Spectral"]), "unexpected text font remains registered");
...
assert(read("zh/index.html").includes('KingHwaOldSong-home-critical.woff2') && read("zh/index.html").includes('class="lux-home-page '), "Chinese homepage does not use its reduced KingHwa subset");
...
assert(productRuntime.includes('lang === "en" ? \' lang="zh-CN"\'') && integrationStyles.includes('html[lang^="en"] body [lang^="zh"]') && integrationStyles.includes('font-family: "KingHwa Old Song" !important'), "Chinese product names in the English interface do not use KingHwa Old Song");
