...
assert(newsletterStyles.includes("backdrop-filter:blur(16px)") && newsletterStyles.includes('html[lang] body .lux-cookie-banner :is(p,button){font:400 13px/1.5'), "cookie banner glass or matching typography is missing");
