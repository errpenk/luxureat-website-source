...
assert(integrationStyles.includes('html[lang^="zh"] body *:not(.material-symbols-outlined)::before') && integrationStyles.includes('html[lang^="zh"] body *:not(.material-symbols-outlined)::after') && integrationStyles.includes('font-family: var(--lux-zh-headline) !important'), "Chinese typography does not reject legacy text or generated-content fonts globally");
