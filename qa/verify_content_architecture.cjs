...
assert(integrationStyles.includes('--lux-zh-headline: "KingHwa Old Song Complete"') && read("zh/contact.html").includes('KingHwaOldSong-complete.ttf'), "Chinese headings do not use the complete KingHwa typography");
assert(integrationStyles.includes('--lux-zh-body: "KingHwa Old Song Complete"') && read("zh/contact.html").includes('KingHwaOldSong-complete.ttf'), "Chinese body copy does not use the complete KingHwa typography");
...
assert(registeredTextFonts.length === 1 && registeredTextFonts[0] === "KingHwa Old Song Complete", "shared CSS does not register the complete KingHwa font");
...
assert(read("zh/index.html").includes('KingHwaOldSong-complete.ttf') && read("zh/index.html").includes('lux-kinghwa-loading') && read("zh/index.html").includes('class="lux-home-page '), "Chinese homepage does not gate text on the complete KingHwa font");
...
assert(!read("zh/index.html").includes('KingHwaOldSong-home-critical.woff2'), "Chinese homepage still uses a reduced KingHwa subset");
...
assert(productRuntime.includes('lang === "en" ? \' lang="zh-CN"\'') && integrationStyles.includes('html[lang^="en"] body [lang^="zh"]') && integrationStyles.includes('font-family: "KingHwa Old Song Complete" !important'), "Chinese product names in the English interface do not use the complete KingHwa font");
