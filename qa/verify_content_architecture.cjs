...
assert(integrationStyles.includes("Mobile certification hero: center the copy without the decorative stem") && integrationStyles.includes(".lux-certification-hero.lux-hero-tail .lux-page-hero-content > .lux-hero-support::before") && integrationStyles.includes("display: none"), "mobile certification hero still reserves space for the decorative stem");
